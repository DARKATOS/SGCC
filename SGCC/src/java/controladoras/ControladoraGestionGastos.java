 ...
 */
@WebServlet(name = "ControladoraGestionGastos", urlPatterns = {"/ControladoraGestionGastos"})
public class ControladoraGestionGastos extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ControladoraGestionGastos</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ControladoraGestionGastos at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
        String operacion=request.getParameter("operacion");
        if ("leerFuentes".equals(operacion)) {
