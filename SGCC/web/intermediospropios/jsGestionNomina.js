...
$(function ()
{
    ...
    function leerEmpleadosNuevaLiquidacion()
    {
        $.post("ControladoraGestionNomina", {
            operacion: "leerEmpleadosNuevaLiquidacion"
        }, function (data) {
            var resultado = data;
            if (resultado == null)
            {
            ...
            {
                var select = document.getElementById("empleadoNL");
    ...
    function calcularSalarioNeto()
    {
        ...
        var salarioNeto = parseInt(salarioBasico)+ parseInt(comisiones)+ parseInt(auxilioTransporte) + parseInt(totalHorasExtra) - parseInt(salud) - parseInt(pension);
    ...
    function calcularSalud()
    {
        ...
        var comisiones = document.getElementById("comisionesNL").value;
        var totalHorasExtra = document.getElementById("totalHorasExtraNL").value;
        var salud = (parseInt(salarioBasico)+ parseInt(comisiones) + parseInt(totalHorasExtra)) * 0.04;
    ...
    function calcularPension()
    {
        ...
        var comisiones = document.getElementById("comisionesNL").value;
        var totalHorasExtra = document.getElementById("totalHorasExtraNL").value;
        var pension = (parseInt(salarioBasico)+ parseInt(comisiones) + parseInt(totalHorasExtra)) * 0.04;
    ...
    function calcularTotalHorasExtra()
    {
        ...
        var totalHorasExtra = parseInt(valorHoraExtra)* parseInt(numeroHorasExtra);
    ...
    function leerLiquidaciones()
    {
        ...
        $.post("ControladoraGestionNomina", {
            ...
            if (resultado == null)
            {
                alert("Error al leer las liquidaciones");
            }
            else
            {
...
//        alert(salarioBasico);
//        alert(comisiones);
//        alert(valorHoraExtra);
//        alert(numeroHorasExtra);
//        alert(empleado);
    ...
    {
        //NO QUIERE ELIMINAR LA BENDITA LIQUIDACION
        var identificador = $('select[name=liquidacionML]').val();
    ...
    function buscarML()
    {
        ...
        $.post("ControladoraGestionNomina", {
            ...
            if (resultado == null)
            {
                alert("Error no se encontro la liquidacion");

            }
            else
            {
                document.getElementById("nombreML").value = resultado.empleado.nombre;
                document.getElementById("salarioBasicoML").value = resultado.empleado.salarioBasico;
    ...
    function buscarEL()
    {
        ...
        $.post("ControladoraGestionNomina", {
            ...
            else
            {
                ...
                document.getElementById("totalHorasExtraEL").value = resultado.totalHorasExtra;
                document.getElementById("saludEL").value = resultado.salud;
                document.getElementById("pensionEL").value = resultado.pension;
                document.getElementById("salarioNetoEL").value = resultado.salarioNeto;
            }
    ...
    function leerIdentifidoresModificar()
    {
        $.post("ControladoraGestionNomina", {
            ...
            if (resultado == null)
            {
                alert("No existen linquidaciones");
            }
            else
            {
